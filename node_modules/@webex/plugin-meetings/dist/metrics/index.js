  ...
  (0, _createClass3.default)(Metrics, [{
    ...
    value: function postEvent(options) {
      ...
      if (this.keys.indexOf(event) === -1) {
        _loggerProxy2.default.logger.error('Metrics:index#postEvent --> Event ' + event + ' doesn\'t exist in dictionary');
      }
      ...
      if (meeting) {
        ...
        _loggerProxy2.default.logger.info('Metrics:index#postEvent --> Event received for meetingId:' + meetingId + ', but meeting not found in collection.');
      }
    }
    ...
    */
      ...
      var payload = {
        ...
        event: {
          ...
          sourceMetadata: {
            ...
            mediaEngineSoftwareType: _bowser2.default.name || 'browser',
            mediaEngineSoftwareVersion: _bowser2.default.osVersion || '-1',
    ...
    value: function userAgentToString() {
      ...
      if (userAgentOption) {
        ...
        return _util2.default.format('webex-js-sdk/%s %s', process.env.NODE_ENV + '-' + this.webex.version, userAgentOption);
      }

      return _util2.default.format('webex-js-sdk/%s', process.env.NODE_ENV + '-' + this.webex.version);
    }
    ...
    value: function sendOperationalMetric(metricName) {
      ...
      var fields = (0, _extends3.default)({}, metricFields, {
        browser_version: _bowser2.default.version,
        os_version: _bowser2.default.osversion,
        sdk_version: this.webex.version
      });

      var tags = (0, _extends3.default)({}, metricTags, {
        browser: _bowser2.default.name,
        org_id: this.webex.credentials.getOrgId(),
        os: _bowser2.default.osname
      });
