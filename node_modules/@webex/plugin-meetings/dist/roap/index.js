...
var Roap = (_temp = _class = function (_StatelessWebexPlugin) {
  ...
  (0, _createClass3.default)(Roap, [{
    ...
    value: function roapEvent(data) {
      ...
      _loggerProxy2.default.logger.log('Roap:index#roapEvent --> Received Roap Message [' + (0, _stringify2.default)(msg, null, 2) + ']');
    ...
    value: function sendRoapOK(options) {
      ...
      return _promise2.default.resolve().then(function () {
        ...
        _loggerProxy2.default.logger.log('Roap:index#sendRoapOK --> ROAP OK sending with seq ' + options.seq);
        ...
        return _this2.roapRequest.sendRoap({
          ...
          _loggerProxy2.default.logger.log('Roap:index#sendRoapOK --> ROAP OK sent with seq ' + options.seq);
