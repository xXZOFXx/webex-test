...
var RoapRequest = function (_StatelessWebexPlugin) {
  ...
  (0, _createClass3.default)(RoapRequest, [{
    ...
    value: function attachRechabilityData(localSdp) {
      ...
      if (reachabilityData) {
        try {
          ...
          _loggerProxy2.default.logger.error('Roap:request#attachReachabilityData --> Error in parsing reachability data: ' + e);
        }
      }
    ...
    value: function joinMeetingWithRoap(options) {
      ...
      _loggerProxy2.default.logger.info('Roap:request#joinMeetingWithRoap --> Join locus with roap');
      _loggerProxy2.default.logger.info('Roap:request#joinMeetingWithRoap --> Local SDP: ' + options.roapMessage);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 15:
                ...
                _loggerProxy2.default.logger.error('Roap:request#joinMeetingWithRoap --> ' + _context.t0);
                throw _context.t0;
              ...
              case 22:
                return _context.abrupt('return', _this2.webex.request({
                  ...
                  _loggerProxy2.default.logger.info('Roap:request#joinMeetingWithRoap --> Joined locus [' + locus.id + '][' + locus.fullState.lastActive + ']');

                  return locus;
                }).catch(function (err) {
                  _loggerProxy2.default.logger.error('Roap:request#joinMeetingWithRoap --> failed with error: ' + err);
                  throw err;
                }));
    ...
    value: function sendRoap(options) {
      ...
      if (!mediaId) {
        _loggerProxy2.default.logger.info('Roap:request#sendRoap --> Race Condition /call mediaID not present');
      }

      var mediaUrl = locusSelfUrl + '/' + _constants.MEDIA;
      var deviceUrl = this.webex.internal.device.url;

      _loggerProxy2.default.logger.info('Roap:request#sendRoap --> ' + mediaUrl + ' \n ' + roapMessage.messageType + ' \n seq:' + roapMessage.seq);
      ...
      return this.webex.request({
        ...
        _loggerProxy2.default.logger.info('Roap:request#sendRoap --> response:' + (0, _stringify2.default)(mediaConnection, null, 2) + '\'\n StatusCode:\'' + res.statusCode);
        var locus = res.body.locus;
        ...
        _loggerProxy2.default.logger.error('Roap:request#sendRoap --> Error:' + (0, _stringify2.default)(err, null, 2));
        _loggerProxy2.default.logger.error('Roap:request#sendRoapRequest --> errorBody:' + (0, _stringify2.default)(roapMessage, null, 2) + ' + \'\\n mediaId:\'' + options.mediaId);
        throw err;
      });
    }
  }]);
