 ...
 * @extends {Error}
 */
var ReconnectInProgress = function (_extendableBuiltin2) {
  (0, _inherits3.default)(ReconnectInProgress, _extendableBuiltin2);

  function ReconnectInProgress() {
    (0, _classCallCheck3.default)(this, ReconnectInProgress);
    return (0, _possibleConstructorReturn3.default)(this, (ReconnectInProgress.__proto__ || (0, _getPrototypeOf2.default)(ReconnectInProgress)).apply(this, arguments));
  }
