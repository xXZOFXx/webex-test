...
Media.getDisplayMedia = function (options) {
  ...
  var shareConstraints = options.sharePreferences && options.sharePreferences.shareConstraints ? options.sharePreferences.shareConstraints : (0, _extends3.default)({
    cursor: 'always',
    aspectRatio: _config2.default.meetings.aspectRatio
  }, options.sharePreferences && options.sharePreferences.highFrameRate ? {
    frameRate: _config2.default.meetings.videoShareFrameRate,
    height: _config2.default.meetings.resolution.idealHeight,
    width: _config2.default.meetings.resolution.idealWidth
  } : {
    frameRate: _config2.default.meetings.screenFrameRate,
