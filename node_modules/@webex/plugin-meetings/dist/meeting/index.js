  ...
  */
  ...
  (0, _createClass3.default)(Meeting, [{
    ...
    value: function muteAudio() {
      ...
      _loggerProxy2.default.logger.info(LOG_HEADER + ' Muting Audio');

      return this.audio.toggle({
        mute: true,
        self: true
      }).then(function () {
        _loggerProxy2.default.logger.info(LOG_HEADER + ' Audio mute successful.');
        _metrics2.default.postEvent({
        ...
        _loggerProxy2.default.logger.error(LOG_HEADER + ' Audio mute error ' + e);
      });
    }
    ...
    */
    ...
    value: function shareScreen() {
      ...
      return _media2.default.getDisplayMedia(shareConstraints).then(function (shareStream) {
        _this44.updateShare({
          sendShare: true,
