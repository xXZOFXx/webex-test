...
function makeWebexStore(type, webex) {
   ...
   */
  var WebexStore = (_dec = (0, _common.oneFlight)({ keyFactory: function keyFactory(namespace) {
      return namespace;
    } }), (_class = function () {
    /**
     * @param {Object} attrs
    ...
    (0, _createClass3.default)(WebexStore, [{
      ...
      value: function _getBinding(namespace) {
        ...
        return new _promise2.default(function (resolve) {
          ...
          return resolve(_this.adapter.bind(namespace, { logger: webex.logger }).then(function (_binding) {
